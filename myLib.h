...
// Background priorities (may not work but we shall see)
#define BG_PRIORITY0        (0<<0)   // low BG_PRIORITY
#define BG_PRIORITY1        (1<<0)   // low BG_PRIORITY
#define BG_PRIORITY2        (2<<0)   // low BG_PRIORITY
#define BG_PRIORITY3        (3<<0)   // low BG_PRIORITY
#define BG_PRIORITY4        (4<<0)   // low BG_PRIORITY
